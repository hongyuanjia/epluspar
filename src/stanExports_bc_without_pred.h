...
namespace model_bc_without_pred_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_bc_without_pred");
    reader.add_event(81, 79, "end", "model_bc_without_pred");
    return reader;
}
#include <stan_meta_header.hpp>
class model_bc_without_pred : public prob_grad {
private:
        int n;
        int m;
        int p;
        ...
        matrix_d z;
public:
    model_bc_without_pred(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_bc_without_pred_namespace::model_bc_without_pred";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_bc_without_pred_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_bc_without_pred_namespace::model_bc_without_pred stan_model;
#endif
