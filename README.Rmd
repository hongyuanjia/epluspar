...
The cmdstanr model fit object is stored in `fit`

```{r stan, fig.path = "man/figures/"}
# Extract draws and create diagnostic plots using bayesplot
library(bayesplot)
mcmc_trace(res$fit$draws())
mcmc_hist(res$fit$draws())
```
